          ...
          <form action="{{ route('inmuebles.update', $inmuebles->id) }}" method="post" class="form-horizontal p-2" enctype="multipart/form-data">
            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Modificar inmuebles</h4>
              </div>
              <div class="card-body">
                 {{-- @if ($errors->any())
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="barrio" placeholder="Ingrese el barrio" value="{{ $inmuebles->barrio }}" autofocus>
                    </div>
                  </div>
                  <div class="row">
                    <label for="" class="col-sm-2 col-form-label">zona</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="zona" placeholder="Ingrese la zona" value="{{ $inmuebles->zona }}" autofocus>
                    </div>
                  </div>
                  <div class="row">
                    <label for="" class="col-sm-2 col-form-label">Direccion</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="direccion" placeholder="Ingrese la direccion" value="{{ $inmuebles->direccion }}" autofocus>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="alcobas" placeholder="alcobas" value="{{ $inmuebles->alcobas }}" autofocus>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="banos" placeholder="baños" value="{{ $inmuebles->banos }}" autofocus>
                    </div>
                  </div>
                  <div class="row">
                    <label for="" class="col-sm-2 col-form-label">area</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="area" placeholder="area" value="{{ $inmuebles->area }}" autofocus>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="valor" placeholder="Valor del inmueble" value="{{ $inmuebles->valor }}" autofocus>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" name="descripcion" placeholder="Valor del inmueble" value="{{ $inmuebles->descripcion }}" autofocus></textarea>
                    </div>
                  </div>
